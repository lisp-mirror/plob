	...
	register SVCXPRT *transp;
{
	...
	case fnRpc_fnClientDbReadRoot:
		_xdr_argument = xdr_SHORTOBJID;
		_xdr_result = xdr_fnClientDbReadRoot_rets;
		local = (char *(*)()) fnrpc_fnclientdbreadroot_1;
		break;

	case fnRpc_fnServerDbWriteRoot:
		_xdr_argument = xdr_fnServerDbWriteRoot_args;
		_xdr_result = xdr_fnServerDbWriteRoot_rets;
		local = (char *(*)()) fnrpc_fnserverdbwriteroot_1;
		break;

	case fnRpc_fnClientDbSessions:
		_xdr_argument = xdr_SHORTOBJID;
		_xdr_result = xdr_fnClientDbSessions_rets;
		local = (char *(*)()) fnrpc_fnclientdbsessions_1;
		break;

	case fnRpc_fnServerGetVersion:
		_xdr_argument = xdr_fnServerGetVersion_args;
		_xdr_result = xdr_fnServerGetVersion_rets;
		local = (char *(*)()) fnrpc_fnservergetversion_1;
		break;

	case fnRpc_fnClientDbCreateMachine:
		_xdr_argument = xdr_fnClientDbCreateMachine_args;
		_xdr_result = xdr_fnClientDbCreateMachine_rets;
		local = (char *(*)()) fnrpc_fnclientdbcreatemachine_1;
		break;

	case fnRpc_fnClientMachineLoginP:
		_xdr_argument = xdr_fnClientMachineLoginP_args;
		_xdr_result = xdr_fnClientMachineLoginP_rets;
		local = (char *(*)()) fnrpc_fnclientmachineloginp_1;
		break;

	case fnRpc_fnClientMachineAddr:
		_xdr_argument = xdr_fnClientMachineAddr_args;
		_xdr_result = xdr_fnClientMachineAddr_rets;
		local = (char *(*)()) fnrpc_fnclientmachineaddr_1;
		break;

	case fnRpc_fnClientDbMachineSearch:
		_xdr_argument = xdr_fnClientDbMachineSearch_args;
		_xdr_result = xdr_fnClientDbMachineSearch_rets;
		local = (char *(*)()) fnrpc_fnclientdbmachinesearch_1;
		break;

	case fnRpc_fnClientDbMachineDelete:
		_xdr_argument = xdr_fnClientDbMachineDelete_args;
		_xdr_result = xdr_fnClientDbMachineDelete_rets;
		local = (char *(*)()) fnrpc_fnclientdbmachinedelete_1;
		break;

	case fnRpc_fnClientDbMachineInsert:
		_xdr_argument = xdr_fnClientDbMachineInsert_args;
		_xdr_result = xdr_fnClientDbMachineInsert_rets;
		local = (char *(*)()) fnrpc_fnclientdbmachineinsert_1;
		break;

	case fnRpc_fnClientDbMachines:
		_xdr_argument = xdr_SHORTOBJID;
		_xdr_result = xdr_fnClientDbMachines_rets;
		local = (char *(*)()) fnrpc_fnclientdbmachines_1;
		break;

	case fnRpc_fnServerGetPortByDirectory:
		_xdr_argument = xdr_fnServerGetPortByDirectory_args;
		_xdr_result = xdr_fnServerGetPortByDirectory_rets;
		local = (char *(*)()) fnrpc_fnservergetportbydirectory_1;
		break;

	case fnRpc_fnServerGetPID:
		_xdr_argument = xdr_void;
		_xdr_result = xdr_fnServerGetPID_rets;
		local = (char *(*)()) fnrpc_fnservergetpid_1;
		break;

	case fnRpc_fnServerGetDirectory:
		_xdr_argument = xdr_fnServerGetDirectory_args;
		_xdr_result = xdr_fnServerGetDirectory_rets;
		local = (char *(*)()) fnrpc_fnservergetdirectory_1;
		break;

	case fnRpc_fnServerExit:
		_xdr_argument = xdr_fnServerExit_args;
		_xdr_result = xdr_fnServerExit_rets;
		local = (char *(*)()) fnrpc_fnserverexit_1;
		break;

	case fnRpc_fnServerDbReset:
		_xdr_argument = xdr_fnServerDbReset_args;
		_xdr_result = xdr_fnServerDbReset_rets;
		local = (char *(*)()) fnrpc_fnserverdbreset_1;
		break;

	case fnRpc_fnServerRestart:
		_xdr_argument = xdr_fnServerRestart_args;
		_xdr_result = xdr_fnServerRestart_rets;
		local = (char *(*)()) fnrpc_fnserverrestart_1;
		break;

	case fnRpc_fnClientObjectCanModify:
		_xdr_argument = xdr_fnClientObjectCanModify_args;
		_xdr_result = xdr_fnClientObjectCanModify_rets;
		local = (char *(*)()) fnrpc_fnclientobjectcanmodify_1;
		break;

	case fnRpc_fnServerDbClose_batch:
		_xdr_argument = xdr_fnServerDbClose_args;
	...
	case fnRpc_fnClientDbConfiguration:
		_xdr_argument = xdr_SHORTOBJID;
		_xdr_result = xdr_fnClientDbConfiguration_rets;
		local = (char *(*)()) fnrpc_fnclientdbconfiguration_1;
		break;

	case fnRpc_fnServerDbCreateObject:
		_xdr_argument = xdr_fnServerDbCreateObject_args;
		_xdr_result = xdr_fnServerDbCreateObject_rets;
		local = (char *(*)()) fnrpc_fnserverdbcreateobject_1;
		break;

	case fnRpc_fnServerDbCreateObjects:
		_xdr_argument = xdr_fnServerDbCreateObjects_args;
		_xdr_result = xdr_fnServerDbCreateObjects_rets;
		local = (char *(*)()) fnrpc_fnserverdbcreateobjects_1;
		break;

	case fnRpc_fnServerObjectDestroy_batch:
		_xdr_argument = xdr_fnServerObjectDestroy_args;
		_xdr_result = xdr_void;
		local = (char *(*)()) fnrpc_fnserverobjectdestroy_batch_1;
		break;

	case fnRpc_fnServerObjectObjIdSize:
		_xdr_argument = xdr_fnServerObjectObjIdSize_args;
		_xdr_result = xdr_fnServerObjectObjIdSize_rets;
		local = (char *(*)()) fnrpc_fnserverobjectobjidsize_1;
		break;

	case fnRpc_fnServerDbOpen:
		_xdr_argument = xdr_fnServerDbOpen_args;
		_xdr_result = xdr_fnServerDbOpen_rets;
		local = (char *(*)()) fnrpc_fnserverdbopen_1;
		break;

	case fnRpc_fnServerObjectFlush:
		_xdr_argument = xdr_fnServerObjectFlush_args;
		_xdr_result = xdr_fnServerObjectFlush_rets;
		local = (char *(*)()) fnrpc_fnserverobjectflush_1;
		break;

	case fnRpc_fnServerObjectReadAtIndex:
		_xdr_argument = xdr_fnServerObjectReadAtIndex_args;
		_xdr_result = xdr_fnServerObjectReadAtIndex_rets;
		local = (char *(*)()) fnrpc_fnserverobjectreadatindex_1;
		break;

	case fnRpc_fnServerObjectReadAtIndices:
		_xdr_argument = xdr_fnServerObjectReadAtIndices_args;
		_xdr_result = xdr_fnServerObjectReadAtIndices_rets;
		local = (char *(*)()) fnrpc_fnserverobjectreadatindices_1;
		break;

	case fnRpc_fnServerObjectReadObjId:
		_xdr_argument = xdr_fnServerObjectReadObjId_args;
		_xdr_result = xdr_fnServerObjectReadObjId_rets;
		local = (char *(*)()) fnrpc_fnserverobjectreadobjid_1;
		break;

	case fnRpc_fnServerObjectReadValues:
		_xdr_argument = xdr_fnServerObjectReadValues_args;
		_xdr_result = xdr_fnServerObjectReadValues_rets;
		local = (char *(*)()) fnrpc_fnserverobjectreadvalues_1;
		break;

	case fnRpc_fnClientDbStatistics:
		_xdr_argument = xdr_SHORTOBJID;
		_xdr_result = xdr_fnClientDbStatistics_rets;
	...
	case fnRpc_fnServerObjectTypeTag:
		_xdr_argument = xdr_fnServerObjectTypeTag_args;
		_xdr_result = xdr_fnServerObjectTypeTag_rets;
		local = (char *(*)()) fnrpc_fnserverobjecttypetag_1;
		break;

	case fnRpc_fnServerObjectValueSize:
		_xdr_argument = xdr_fnServerObjectValueSize_args;
		_xdr_result = xdr_fnServerObjectValueSize_rets;
		local = (char *(*)()) fnrpc_fnserverobjectvaluesize_1;
		break;

	case fnRpc_fnServerObjectWriteAtIndex:
		_xdr_argument = xdr_fnServerObjectWriteAtIndex_args;
		_xdr_result = xdr_fnServerObjectWriteAtIndex_rets;
		local = (char *(*)()) fnrpc_fnserverobjectwriteatindex_1;
		break;

	case fnRpc_fnServerObjectWriteAtIndices:
		_xdr_argument = xdr_fnServerObjectWriteAtIndices_args;
		_xdr_result = xdr_fnServerObjectWriteAtIndices_rets;
		local = (char *(*)()) fnrpc_fnserverobjectwriteatindices_1;
		break;

	case fnRpc_fnServerObjectWriteObjId:
		_xdr_argument = xdr_fnServerObjectWriteObjId_args;
		_xdr_result = xdr_fnServerObjectWriteObjId_rets;
		local = (char *(*)()) fnrpc_fnserverobjectwriteobjid_1;
		break;

	case fnRpc_fnServerObjectWriteValues:
		_xdr_argument = xdr_fnServerObjectWriteValues_args;
		_xdr_result = xdr_fnServerObjectWriteValues_rets;
		local = (char *(*)()) fnrpc_fnserverobjectwritevalues_1;
		break;

	case fnRpc_fnShortMakeDependent:
		_xdr_argument = xdr_fnShortMakeDependent_args;
		_xdr_result = xdr_fnShortMakeDependent_rets;
		local = (char *(*)()) fnrpc_fnshortmakedependent_1;
		break;

	case fnRpc_fnServerObjectPeekSlots:
		_xdr_argument = xdr_fnServerObjectPeekSlots_args;
		_xdr_result = xdr_fnServerObjectPeekSlots_rets;
		local = (char *(*)()) fnrpc_fnserverobjectpeekslots_1;
		break;

	case fnRpc_fnServerObjectPeekValues:
		_xdr_argument = xdr_fnServerObjectPeekValues_args;
		_xdr_result = xdr_fnServerObjectPeekValues_rets;
		local = (char *(*)()) fnrpc_fnserverobjectpeekvalues_1;
		break;

	case fnRpc_fnServerObjectPoke_batch:
		_xdr_argument = xdr_fnServerObjectPoke_args;
		_xdr_result = xdr_void;
		local = (char *(*)()) fnrpc_fnserverobjectpoke_batch_1;
		break;

	case fnRpc_fnFlushMode:
		_xdr_argument = xdr_fnFlushMode_args;
		_xdr_result = xdr_fnFlushMode_rets;
		local = (char *(*)()) fnrpc_fnflushmode_1;
		break;

	case fnRpc_fnFlagWord:
		_xdr_argument = xdr_fnFlagWord_args;
		_xdr_result = xdr_fnFlagWord_rets;
		local = (char *(*)()) fnrpc_fnflagword_1;
		break;

	case fnRpc_fnShortMakeIVector:
		_xdr_argument = xdr_fnShortMakeIVector_args;
		_xdr_result = xdr_fnShortMakeIVector_rets;
		local = (char *(*)()) fnrpc_fnshortmakeivector_1;
		break;

	case fnRpc_fnShortMakeString:
		_xdr_argument = xdr_fnShortMakeString_args;
		_xdr_result = xdr_fnShortMakeString_rets;
		local = (char *(*)()) fnrpc_fnshortmakestring_1;
		break;

	case fnRpc_fnServerDbCreateStructures:
		_xdr_argument = xdr_fnServerDbCreateStructures_args;
		_xdr_result = xdr_fnServerDbCreateStructures_rets;
		local = (char *(*)()) fnrpc_fnserverdbcreatestructures_1;
		break;

	case fnRpc_fnServerDbCreateInstances:
		_xdr_argument = xdr_fnServerDbCreateInstances_args;
		_xdr_result = xdr_fnServerDbCreateInstances_rets;
		local = (char *(*)()) fnrpc_fnserverdbcreateinstances_1;
		break;

	case fnRpc_fnServerInstanceWriteWrapper:
		_xdr_argument = xdr_fnServerInstanceWriteWrapper_args;
		_xdr_result = xdr_fnServerInstanceWriteWrapper_rets;
		local = (char *(*)()) fnrpc_fnserverinstancewritewrapper_1;
		break;

	case fnRpc_fnServerInstanceWriteData:
		_xdr_argument = xdr_fnServerInstanceWriteData_args;
		_xdr_result = xdr_fnServerInstanceWriteData_rets;
		local = (char *(*)()) fnrpc_fnserverinstancewritedata_1;
		break;

	case fnRpc_fnServerDbTypeTagName:
		_xdr_argument = xdr_SHTYPETAG;
		_xdr_result = xdr_fnServerDbTypeTagName_rets;
		local = (char *(*)()) fnrpc_fnserverdbtypetagname_1;
		break;

	case fnRpc_fnServerObjectPrettyPrint:
		_xdr_argument = xdr_fnServerObjectPrettyPrint_args;
		_xdr_result = xdr_fnServerObjectPrettyPrint_rets;
		local = (char *(*)()) fnrpc_fnserverobjectprettyprint_1;
		break;

	case fnRpc_fnShortPrintSymbol:
		_xdr_argument = xdr_fnShortPrintSymbol_args;
		_xdr_result = xdr_fnShortPrintSymbol_rets;
		local = (char *(*)()) fnrpc_fnshortprintsymbol_1;
		break;

	case fnRpc_fnShortMakeSingleFloat:
		_xdr_argument = xdr_fnShortMakeSingleFloat_args;
		_xdr_result = xdr_fnShortMakeSingleFloat_rets;
		local = (char *(*)()) fnrpc_fnshortmakesinglefloat_1;
		break;

	case fnRpc_fnShortMakeDoubleFloat:
		_xdr_argument = xdr_fnShortMakeDoubleFloat_args;
		_xdr_result = xdr_fnShortMakeDoubleFloat_rets;
		local = (char *(*)()) fnrpc_fnshortmakedoublefloat_1;
		break;

	case fnRpc_fnServerDbMakeBignum:
		_xdr_argument = xdr_fnServerDbMakeBignum_args;
		_xdr_result = xdr_fnServerDbMakeBignum_rets;
		local = (char *(*)()) fnrpc_fnserverdbmakebignum_1;
		break;

	case fnRpc_fnServerObjectReadBignum:
		_xdr_argument = xdr_fnServerObjectReadBignum_args;
		_xdr_result = xdr_fnServerObjectReadBignum_rets;
		local = (char *(*)()) fnrpc_fnserverobjectreadbignum_1;
		break;

	case fnRpc_fnServerObjectReadDoubleFloat:
		_xdr_argument = xdr_fnServerObjectReadDoubleFloat_args;
		_xdr_result = xdr_fnServerObjectReadDoubleFloat_rets;
		local = (char *(*)()) fnrpc_fnserverobjectreaddoublefloat_1;
		break;

	case fnRpc_fnServerObjectReadFixnum:
		_xdr_argument = xdr_fnServerObjectReadFixnum_args;
		_xdr_result = xdr_fnServerObjectReadFixnum_rets;
		local = (char *(*)()) fnrpc_fnserverobjectreadfixnum_1;
		break;

	case fnRpc_fnServerObjectReadSingleFloat:
		_xdr_argument = xdr_fnServerObjectReadSingleFloat_args;
		_xdr_result = xdr_fnServerObjectReadSingleFloat_rets;
		local = (char *(*)()) fnrpc_fnserverobjectreadsinglefloat_1;
		break;

	case fnRpc_fnServerObjectWriteBignum:
		_xdr_argument = xdr_fnServerObjectWriteBignum_args;
		_xdr_result = xdr_fnServerObjectWriteBignum_rets;
		local = (char *(*)()) fnrpc_fnserverobjectwritebignum_1;
		break;

	case fnRpc_fnServerObjectWriteDoubleFloat:
		_xdr_argument = xdr_fnServerObjectWriteDoubleFloat_args;
		_xdr_result = xdr_fnServerObjectWriteDoubleFloat_rets;
		local = (char *(*)()) fnrpc_fnserverobjectwritedoublefloat_1;
		break;

	case fnRpc_fnServerObjectWriteFixnum:
		_xdr_argument = xdr_fnServerObjectWriteFixnum_args;
		_xdr_result = xdr_fnServerObjectWriteFixnum_rets;
		local = (char *(*)()) fnrpc_fnserverobjectwritefixnum_1;
		break;

	case fnRpc_fnServerObjectWriteSingleFloat:
		_xdr_argument = xdr_fnServerObjectWriteSingleFloat_args;
		_xdr_result = xdr_fnServerObjectWriteSingleFloat_rets;
		local = (char *(*)()) fnrpc_fnserverobjectwritesinglefloat_1;
		break;

	case fnRpc_fnClientLockPrint:
		_xdr_argument = xdr_fnClientLockPrint_args;
		_xdr_result = xdr_fnClientLockPrint_rets;
		local = (char *(*)()) fnrpc_fnclientlockprint_1;
		break;

	case fnRpc_fnClientTransactionLockGet:
		_xdr_argument = xdr_fnClientTransactionLockGet_args;
		_xdr_result = xdr_fnClientTransactionLockGet_rets;
		local = (char *(*)()) fnrpc_fnclienttransactionlockget_1;
		break;

	case fnRpc_fnServerTransactionLockInsert:
		_xdr_argument = xdr_fnServerTransactionLockInsert_args;
		_xdr_result = xdr_fnServerTransactionLockInsert_rets;
		local = (char *(*)()) fnrpc_fnservertransactionlockinsert_1;
		break;

	case fnRpc_fnServerTransactionLockSet:
		_xdr_argument = xdr_fnServerTransactionLockSet_args;
		_xdr_result = xdr_fnServerTransactionLockSet_rets;
		local = (char *(*)()) fnrpc_fnservertransactionlockset_1;
		break;

	case fnRpc_fnServerTransactionUnlock:
		_xdr_argument = xdr_fnServerTransactionUnlock_args;
		_xdr_result = xdr_fnServerTransactionUnlock_rets;
		local = (char *(*)()) fnrpc_fnservertransactionunlock_1;
		break;

	case fnRpc_fnServerTransactionUnlockAll:
		_xdr_argument = xdr_fnServerTransactionUnlockAll_args;
		_xdr_result = xdr_fnServerTransactionUnlockAll_rets;
		local = (char *(*)()) fnrpc_fnservertransactionunlockall_1;
		break;

	case fnRpc_fnServerTransactionUnlockAllAll:
		_xdr_argument = xdr_fnServerTransactionUnlockAllAll_args;
		_xdr_result = xdr_fnServerTransactionUnlockAllAll_rets;
		local = (char *(*)()) fnrpc_fnservertransactionunlockallall_1;
		break;

	case fnRpc_fnShortMakeReadOnly:
		_xdr_argument = xdr_fnShortMakeReadOnly_args;
		_xdr_result = xdr_fnShortMakeReadOnly_rets;
		local = (char *(*)()) fnrpc_fnshortmakereadonly_1;
		break;

	case fnRpc_fnServerTransactionBegin:
		_xdr_argument = xdr_fnServerTransactionBegin_args;
		_xdr_result = xdr_fnServerTransactionBegin_rets;
		local = (char *(*)()) fnrpc_fnservertransactionbegin_1;
		break;

	case fnRpc_fnServerTransactionCancel:
		_xdr_argument = xdr_fnServerTransactionCancel_args;
		_xdr_result = xdr_fnServerTransactionCancel_rets;
		local = (char *(*)()) fnrpc_fnservertransactioncancel_1;
		break;

	case fnRpc_fnServerTransactionEnd:
		_xdr_argument = xdr_fnServerTransactionEnd_args;
		_xdr_result = xdr_fnServerTransactionEnd_rets;
	...
	case fnRpc_fnServerDbTransactionP:
		_xdr_argument = xdr_fnServerDbTransactionP_args;
		_xdr_result = xdr_fnServerDbTransactionP_rets;
		local = (char *(*)()) fnrpc_fnserverdbtransactionp_1;
		break;

	case fnRpc_fnClientBtreeClear:
		_xdr_argument = xdr_fnClientBtreeClear_args;
		_xdr_result = xdr_fnClientBtreeClear_rets;
		local = (char *(*)()) fnrpc_fnclientbtreeclear_1;
		break;

	case fnRpc_fnClientBtreeCount:
		_xdr_argument = xdr_fnClientBtreeCount_args;
		_xdr_result = xdr_fnClientBtreeCount_rets;
		local = (char *(*)()) fnrpc_fnclientbtreecount_1;
		break;

	case fnRpc_fnServerBtreeDelete:
		_xdr_argument = xdr_fnServerBtreeDelete_args;
		_xdr_result = xdr_fnServerBtreeDelete_rets;
		local = (char *(*)()) fnrpc_fnserverbtreedelete_1;
		break;

	case fnRpc_fnServerBtreeDeleteByFloat:
		_xdr_argument = xdr_fnServerBtreeDeleteByFloat_args;
		_xdr_result = xdr_fnServerBtreeDeleteByFloat_rets;
		local = (char *(*)()) fnrpc_fnserverbtreedeletebyfloat_1;
		break;

	case fnRpc_fnServerBtreeDeleteByDouble:
		_xdr_argument = xdr_fnServerBtreeDeleteByDouble_args;
		_xdr_result = xdr_fnServerBtreeDeleteByDouble_rets;
		local = (char *(*)()) fnrpc_fnserverbtreedeletebydouble_1;
		break;

	case fnRpc_fnServerBtreeDeleteByString:
		_xdr_argument = xdr_fnServerBtreeDeleteByString_args;
		_xdr_result = xdr_fnServerBtreeDeleteByString_rets;
		local = (char *(*)()) fnrpc_fnserverbtreedeletebystring_1;
		break;

	case fnRpc_fnServerBtreeInsert:
		_xdr_argument = xdr_fnServerBtreeInsert_args;
		_xdr_result = xdr_fnServerBtreeInsert_rets;
		local = (char *(*)()) fnrpc_fnserverbtreeinsert_1;
		break;

	case fnRpc_fnServerBtreeInsertByFloat:
		_xdr_argument = xdr_fnServerBtreeInsertByFloat_args;
		_xdr_result = xdr_fnServerBtreeInsertByFloat_rets;
		local = (char *(*)()) fnrpc_fnserverbtreeinsertbyfloat_1;
		break;

	case fnRpc_fnServerBtreeInsertByDouble:
		_xdr_argument = xdr_fnServerBtreeInsertByDouble_args;
		_xdr_result = xdr_fnServerBtreeInsertByDouble_rets;
		local = (char *(*)()) fnrpc_fnserverbtreeinsertbydouble_1;
		break;

	case fnRpc_fnServerBtreeInsertByString:
		_xdr_argument = xdr_fnServerBtreeInsertByString_args;
		_xdr_result = xdr_fnServerBtreeInsertByString_rets;
		local = (char *(*)()) fnrpc_fnserverbtreeinsertbystring_1;
		break;

	case fnRpc_fnServerBtreemapSearch:
		_xdr_argument = xdr_fnServerBtreemapSearch_args;
		_xdr_result = xdr_fnServerBtreemapSearch_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapsearch_1;
		break;

	case fnRpc_fnServerBtreemapSearchByFloat:
		_xdr_argument = xdr_fnServerBtreemapSearchByFloat_args;
		_xdr_result = xdr_fnServerBtreemapSearchByFloat_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapsearchbyfloat_1;
		break;

	case fnRpc_fnServerBtreemapSearchByDouble:
		_xdr_argument = xdr_fnServerBtreemapSearchByDouble_args;
		_xdr_result = xdr_fnServerBtreemapSearchByDouble_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapsearchbydouble_1;
		break;

	case fnRpc_fnServerBtreemapSearchByString:
		_xdr_argument = xdr_fnServerBtreemapSearchByString_args;
		_xdr_result = xdr_fnServerBtreemapSearchByString_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapsearchbystring_1;
		break;

	case fnRpc_fnServerBtreemapSeek:
		_xdr_argument = xdr_fnServerBtreemapSeek_args;
		_xdr_result = xdr_fnServerBtreemapSeek_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapseek_1;
		break;

	case fnRpc_fnServerBtreemapSeekSet:
		_xdr_argument = xdr_fnServerBtreemapSeekSet_args;
		_xdr_result = xdr_fnServerBtreemapSeekSet_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapseekset_1;
		break;

	case fnRpc_fnServerBtreemapFirst:
		_xdr_argument = xdr_fnServerBtreemapFirst_args;
		_xdr_result = xdr_fnServerBtreemapFirst_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapfirst_1;
		break;

	case fnRpc_fnServerBtreemapFirstByFloat:
		_xdr_argument = xdr_fnServerBtreemapFirstByFloat_args;
		_xdr_result = xdr_fnServerBtreemapFirstByFloat_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapfirstbyfloat_1;
		break;

	case fnRpc_fnServerBtreemapFirstByDouble:
		_xdr_argument = xdr_fnServerBtreemapFirstByDouble_args;
		_xdr_result = xdr_fnServerBtreemapFirstByDouble_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapfirstbydouble_1;
		break;

	case fnRpc_fnServerBtreemapFirstByString:
		_xdr_argument = xdr_fnServerBtreemapFirstByString_args;
		_xdr_result = xdr_fnServerBtreemapFirstByString_rets;
		local = (char *(*)()) fnrpc_fnserverbtreemapfirstbystring_1;
		break;

	case fnRpc_fnClientBtreemapNext:
		_xdr_argument = xdr_fnClientBtreemapNext_args;
		_xdr_result = xdr_fnClientBtreemapNext_rets;
		local = (char *(*)()) fnrpc_fnclientbtreemapnext_1;
		break;

	case fnRpc_fnClientBtreemapLast:
		_xdr_argument = xdr_fnClientBtreemapLast_args;
		_xdr_result = xdr_fnClientBtreemapLast_rets;
		local = (char *(*)()) fnrpc_fnclientbtreemaplast_1;
		break;

	case fnRpc_fnClientBtreePrint:
		_xdr_argument = xdr_fnClientBtreePrint_args;
		_xdr_result = xdr_fnClientBtreePrint_rets;
		local = (char *(*)()) fnrpc_fnclientbtreeprint_1;
		break;

	case fnRpc_fnServerBtreeSearch:
		_xdr_argument = xdr_fnServerBtreeSearch_args;
		_xdr_result = xdr_fnServerBtreeSearch_rets;
		local = (char *(*)()) fnrpc_fnserverbtreesearch_1;
		break;

	case fnRpc_fnServerBtreeSearchByFloat:
		_xdr_argument = xdr_fnServerBtreeSearchByFloat_args;
		_xdr_result = xdr_fnServerBtreeSearchByFloat_rets;
		local = (char *(*)()) fnrpc_fnserverbtreesearchbyfloat_1;
		break;

	case fnRpc_fnServerBtreeSearchByDouble:
		_xdr_argument = xdr_fnServerBtreeSearchByDouble_args;
		_xdr_result = xdr_fnServerBtreeSearchByDouble_rets;
		local = (char *(*)()) fnrpc_fnserverbtreesearchbydouble_1;
		break;

	case fnRpc_fnServerBtreeSearchByString:
		_xdr_argument = xdr_fnServerBtreeSearchByString_args;
		_xdr_result = xdr_fnServerBtreeSearchByString_rets;
		local = (char *(*)()) fnrpc_fnserverbtreesearchbystring_1;
		break;

	case fnRpc_fnClientBtreeRoot:
		_xdr_argument = xdr_fnClientBtreeRoot_args;
		_xdr_result = xdr_fnClientBtreeRoot_rets;
		local = (char *(*)()) fnrpc_fnclientbtreeroot_1;
		break;

	case fnRpc_fnClientBtreeSize:
		_xdr_argument = xdr_fnClientBtreeSize_args;
		_xdr_result = xdr_fnClientBtreeSize_rets;
		local = (char *(*)()) fnrpc_fnclientbtreesize_1;
		break;

	case fnRpc_fnClientBtreeTestMode:
		_xdr_argument = xdr_fnClientBtreeTestMode_args;
		_xdr_result = xdr_fnClientBtreeTestMode_rets;
		local = (char *(*)()) fnrpc_fnclientbtreetestmode_1;
		break;

	case fnRpc_fnClientBtreePageSize:
		_xdr_argument = xdr_fnClientBtreePageSize_args;
		_xdr_result = xdr_fnClientBtreePageSize_rets;
		local = (char *(*)()) fnrpc_fnclientbtreepagesize_1;
		break;

	case fnRpc_fnClientBtreepageParent:
		_xdr_argument = xdr_fnClientBtreepageParent_args;
		_xdr_result = xdr_fnClientBtreepageParent_rets;
		local = (char *(*)()) fnrpc_fnclientbtreepageparent_1;
		break;

	case fnRpc_fnClientBtreepageCount:
		_xdr_argument = xdr_fnClientBtreepageCount_args;
		_xdr_result = xdr_fnClientBtreepageCount_rets;
		local = (char *(*)()) fnrpc_fnclientbtreepagecount_1;
		break;

	case fnRpc_fnClientBtreepageGetSize:
		_xdr_argument = xdr_fnClientBtreepageGetSize_args;
		_xdr_result = xdr_fnClientBtreepageGetSize_rets;
		local = (char *(*)()) fnrpc_fnclientbtreepagegetsize_1;
		break;

	case fnRpc_fnClientBtreepageItem:
		_xdr_argument = xdr_fnClientBtreepageItem_args;
		_xdr_result = xdr_fnClientBtreepageItem_rets;
...
main()
{
	...
	if (t_getstate(0) != -1 || t_errno != TBADF) {
		...
		_rpcpmstart = 1;
		openlog("plobd", LOG_PID, LOG_DAEMON);
		...
		if (!svc_reg(transp, PLOBD, PLOBDVERS, plobd_1, 0)) {
			_msgout("unable to register (PLOBD, PLOBDVERS).");
			exit(1);
		}
		if (pmclose) {
			(void) signal(SIGALRM, (void(*)()) closedown);
	...
	if (!svc_create(plobd_1, PLOBD, PLOBDVERS, "netpath")) {
		_msgout("unable to create (PLOBD, PLOBDVERS) for netpath.");
		exit(1);
	}
