...
static void
plobd_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
	...
	case fnRpc_fnClientDbReadRoot:
		_xdr_argument = (xdrproc_t) xdr_SHORTOBJID;
		_xdr_result = (xdrproc_t) xdr_fnClientDbReadRoot_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientdbreadroot_1_svc;
		break;

	case fnRpc_fnServerDbWriteRoot:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbWriteRoot_args;
		_xdr_result = (xdrproc_t) xdr_fnServerDbWriteRoot_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbwriteroot_1_svc;
		break;

	case fnRpc_fnClientDbSessions:
		_xdr_argument = (xdrproc_t) xdr_SHORTOBJID;
		_xdr_result = (xdrproc_t) xdr_fnClientDbSessions_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientdbsessions_1_svc;
		break;

	case fnRpc_fnServerGetVersion:
		_xdr_argument = (xdrproc_t) xdr_fnServerGetVersion_args;
		_xdr_result = (xdrproc_t) xdr_fnServerGetVersion_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservergetversion_1_svc;
		break;

	case fnRpc_fnClientDbCreateMachine:
		_xdr_argument = (xdrproc_t) xdr_fnClientDbCreateMachine_args;
		_xdr_result = (xdrproc_t) xdr_fnClientDbCreateMachine_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientdbcreatemachine_1_svc;
		break;

	case fnRpc_fnClientMachineLoginP:
		_xdr_argument = (xdrproc_t) xdr_fnClientMachineLoginP_args;
		_xdr_result = (xdrproc_t) xdr_fnClientMachineLoginP_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientmachineloginp_1_svc;
		break;

	case fnRpc_fnClientMachineAddr:
		_xdr_argument = (xdrproc_t) xdr_fnClientMachineAddr_args;
		_xdr_result = (xdrproc_t) xdr_fnClientMachineAddr_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientmachineaddr_1_svc;
		break;

	case fnRpc_fnClientDbMachineSearch:
		_xdr_argument = (xdrproc_t) xdr_fnClientDbMachineSearch_args;
		_xdr_result = (xdrproc_t) xdr_fnClientDbMachineSearch_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientdbmachinesearch_1_svc;
		break;

	case fnRpc_fnClientDbMachineDelete:
		_xdr_argument = (xdrproc_t) xdr_fnClientDbMachineDelete_args;
		_xdr_result = (xdrproc_t) xdr_fnClientDbMachineDelete_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientdbmachinedelete_1_svc;
		break;

	case fnRpc_fnClientDbMachineInsert:
		_xdr_argument = (xdrproc_t) xdr_fnClientDbMachineInsert_args;
		_xdr_result = (xdrproc_t) xdr_fnClientDbMachineInsert_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientdbmachineinsert_1_svc;
		break;

	case fnRpc_fnClientDbMachines:
		_xdr_argument = (xdrproc_t) xdr_SHORTOBJID;
		_xdr_result = (xdrproc_t) xdr_fnClientDbMachines_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientdbmachines_1_svc;
		break;

	case fnRpc_fnServerGetPortByDirectory:
		_xdr_argument = (xdrproc_t) xdr_fnServerGetPortByDirectory_args;
		_xdr_result = (xdrproc_t) xdr_fnServerGetPortByDirectory_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservergetportbydirectory_1_svc;
		break;

	case fnRpc_fnServerGetPID:
		_xdr_argument = (xdrproc_t) xdr_void;
		_xdr_result = (xdrproc_t) xdr_fnServerGetPID_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservergetpid_1_svc;
		break;

	case fnRpc_fnServerGetDirectory:
		_xdr_argument = (xdrproc_t) xdr_fnServerGetDirectory_args;
		_xdr_result = (xdrproc_t) xdr_fnServerGetDirectory_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservergetdirectory_1_svc;
		break;

	case fnRpc_fnServerExit:
		_xdr_argument = (xdrproc_t) xdr_fnServerExit_args;
		_xdr_result = (xdrproc_t) xdr_fnServerExit_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverexit_1_svc;
		break;

	case fnRpc_fnServerDbReset:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbReset_args;
		_xdr_result = (xdrproc_t) xdr_fnServerDbReset_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbreset_1_svc;
		break;

	case fnRpc_fnServerRestart:
		_xdr_argument = (xdrproc_t) xdr_fnServerRestart_args;
		_xdr_result = (xdrproc_t) xdr_fnServerRestart_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverrestart_1_svc;
		break;

	case fnRpc_fnClientObjectCanModify:
		_xdr_argument = (xdrproc_t) xdr_fnClientObjectCanModify_args;
		_xdr_result = (xdrproc_t) xdr_fnClientObjectCanModify_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientobjectcanmodify_1_svc;
		break;

	case fnRpc_fnServerDbClose_batch:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbClose_args;
		_xdr_result = (xdrproc_t) xdr_void;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbclose_batch_1_svc;
		break;

	case fnRpc_fnClientDbConfiguration:
		_xdr_argument = (xdrproc_t) xdr_SHORTOBJID;
		_xdr_result = (xdrproc_t) xdr_fnClientDbConfiguration_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientdbconfiguration_1_svc;
		break;

	case fnRpc_fnServerDbCreateObject:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbCreateObject_args;
		_xdr_result = (xdrproc_t) xdr_fnServerDbCreateObject_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbcreateobject_1_svc;
		break;

	case fnRpc_fnServerDbCreateObjects:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbCreateObjects_args;
		_xdr_result = (xdrproc_t) xdr_fnServerDbCreateObjects_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbcreateobjects_1_svc;
		break;

	case fnRpc_fnServerObjectDestroy_batch:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectDestroy_args;
		_xdr_result = (xdrproc_t) xdr_void;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectdestroy_batch_1_svc;
		break;

	case fnRpc_fnServerObjectObjIdSize:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectObjIdSize_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectObjIdSize_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectobjidsize_1_svc;
		break;

	case fnRpc_fnServerDbOpen:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbOpen_args;
		_xdr_result = (xdrproc_t) xdr_fnServerDbOpen_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbopen_1_svc;
		break;

	case fnRpc_fnServerObjectFlush:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectFlush_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectFlush_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectflush_1_svc;
		break;

	case fnRpc_fnServerObjectReadAtIndex:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectReadAtIndex_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectReadAtIndex_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectreadatindex_1_svc;
		break;

	case fnRpc_fnServerObjectReadAtIndices:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectReadAtIndices_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectReadAtIndices_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectreadatindices_1_svc;
		break;

	case fnRpc_fnServerObjectReadObjId:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectReadObjId_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectReadObjId_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectreadobjid_1_svc;
		break;

	case fnRpc_fnServerObjectReadValues:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectReadValues_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectReadValues_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectreadvalues_1_svc;
		break;

	case fnRpc_fnClientDbStatistics:
		_xdr_argument = (xdrproc_t) xdr_SHORTOBJID;
		_xdr_result = (xdrproc_t) xdr_fnClientDbStatistics_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientdbstatistics_1_svc;
		break;

	case fnRpc_fnServerDbStabilise_batch:
		_xdr_argument = (xdrproc_t) xdr_SHORTOBJID;
		_xdr_result = (xdrproc_t) xdr_void;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbstabilise_batch_1_svc;
		break;

	case fnRpc_fnServerObjectTypeTag:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectTypeTag_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectTypeTag_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjecttypetag_1_svc;
		break;

	case fnRpc_fnServerObjectValueSize:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectValueSize_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectValueSize_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectvaluesize_1_svc;
		break;

	case fnRpc_fnServerObjectWriteAtIndex:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectWriteAtIndex_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectWriteAtIndex_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectwriteatindex_1_svc;
		break;

	case fnRpc_fnServerObjectWriteAtIndices:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectWriteAtIndices_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectWriteAtIndices_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectwriteatindices_1_svc;
		break;

	case fnRpc_fnServerObjectWriteObjId:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectWriteObjId_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectWriteObjId_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectwriteobjid_1_svc;
		break;

	case fnRpc_fnServerObjectWriteValues:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectWriteValues_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectWriteValues_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectwritevalues_1_svc;
		break;

	case fnRpc_fnShortMakeDependent:
		_xdr_argument = (xdrproc_t) xdr_fnShortMakeDependent_args;
		_xdr_result = (xdrproc_t) xdr_fnShortMakeDependent_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnshortmakedependent_1_svc;
		break;

	case fnRpc_fnServerObjectPeekSlots:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectPeekSlots_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectPeekSlots_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectpeekslots_1_svc;
		break;

	case fnRpc_fnServerObjectPeekValues:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectPeekValues_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectPeekValues_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectpeekvalues_1_svc;
		break;

	case fnRpc_fnServerObjectPoke_batch:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectPoke_args;
		_xdr_result = (xdrproc_t) xdr_void;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectpoke_batch_1_svc;
		break;

	case fnRpc_fnFlushMode:
		_xdr_argument = (xdrproc_t) xdr_fnFlushMode_args;
		_xdr_result = (xdrproc_t) xdr_fnFlushMode_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnflushmode_1_svc;
		break;

	case fnRpc_fnFlagWord:
		_xdr_argument = (xdrproc_t) xdr_fnFlagWord_args;
		_xdr_result = (xdrproc_t) xdr_fnFlagWord_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnflagword_1_svc;
		break;

	case fnRpc_fnShortMakeIVector:
		_xdr_argument = (xdrproc_t) xdr_fnShortMakeIVector_args;
		_xdr_result = (xdrproc_t) xdr_fnShortMakeIVector_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnshortmakeivector_1_svc;
		break;

	case fnRpc_fnShortMakeString:
		_xdr_argument = (xdrproc_t) xdr_fnShortMakeString_args;
		_xdr_result = (xdrproc_t) xdr_fnShortMakeString_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnshortmakestring_1_svc;
		break;

	case fnRpc_fnServerDbCreateStructures:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbCreateStructures_args;
		_xdr_result = (xdrproc_t) xdr_fnServerDbCreateStructures_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbcreatestructures_1_svc;
		break;

	case fnRpc_fnServerDbCreateInstances:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbCreateInstances_args;
		_xdr_result = (xdrproc_t) xdr_fnServerDbCreateInstances_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbcreateinstances_1_svc;
		break;

	case fnRpc_fnServerInstanceWriteWrapper:
		_xdr_argument = (xdrproc_t) xdr_fnServerInstanceWriteWrapper_args;
		_xdr_result = (xdrproc_t) xdr_fnServerInstanceWriteWrapper_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverinstancewritewrapper_1_svc;
		break;

	case fnRpc_fnServerInstanceWriteData:
		_xdr_argument = (xdrproc_t) xdr_fnServerInstanceWriteData_args;
		_xdr_result = (xdrproc_t) xdr_fnServerInstanceWriteData_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverinstancewritedata_1_svc;
		break;

	case fnRpc_fnServerDbTypeTagName:
		_xdr_argument = (xdrproc_t) xdr_SHTYPETAG;
		_xdr_result = (xdrproc_t) xdr_fnServerDbTypeTagName_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbtypetagname_1_svc;
		break;

	case fnRpc_fnServerObjectPrettyPrint:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectPrettyPrint_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectPrettyPrint_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectprettyprint_1_svc;
		break;

	case fnRpc_fnShortPrintSymbol:
		_xdr_argument = (xdrproc_t) xdr_fnShortPrintSymbol_args;
		_xdr_result = (xdrproc_t) xdr_fnShortPrintSymbol_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnshortprintsymbol_1_svc;
		break;

	case fnRpc_fnShortMakeSingleFloat:
		_xdr_argument = (xdrproc_t) xdr_fnShortMakeSingleFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnShortMakeSingleFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnshortmakesinglefloat_1_svc;
		break;

	case fnRpc_fnShortMakeDoubleFloat:
		_xdr_argument = (xdrproc_t) xdr_fnShortMakeDoubleFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnShortMakeDoubleFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnshortmakedoublefloat_1_svc;
		break;

	case fnRpc_fnServerDbMakeBignum:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbMakeBignum_args;
		_xdr_result = (xdrproc_t) xdr_fnServerDbMakeBignum_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbmakebignum_1_svc;
		break;

	case fnRpc_fnServerObjectReadBignum:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectReadBignum_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectReadBignum_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectreadbignum_1_svc;
		break;

	case fnRpc_fnServerObjectReadDoubleFloat:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectReadDoubleFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectReadDoubleFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectreaddoublefloat_1_svc;
		break;

	case fnRpc_fnServerObjectReadFixnum:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectReadFixnum_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectReadFixnum_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectreadfixnum_1_svc;
		break;

	case fnRpc_fnServerObjectReadSingleFloat:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectReadSingleFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectReadSingleFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectreadsinglefloat_1_svc;
		break;

	case fnRpc_fnServerObjectWriteBignum:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectWriteBignum_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectWriteBignum_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectwritebignum_1_svc;
		break;

	case fnRpc_fnServerObjectWriteDoubleFloat:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectWriteDoubleFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectWriteDoubleFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectwritedoublefloat_1_svc;
		break;

	case fnRpc_fnServerObjectWriteFixnum:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectWriteFixnum_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectWriteFixnum_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectwritefixnum_1_svc;
		break;

	case fnRpc_fnServerObjectWriteSingleFloat:
		_xdr_argument = (xdrproc_t) xdr_fnServerObjectWriteSingleFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnServerObjectWriteSingleFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverobjectwritesinglefloat_1_svc;
		break;

	case fnRpc_fnClientLockPrint:
		_xdr_argument = (xdrproc_t) xdr_fnClientLockPrint_args;
		_xdr_result = (xdrproc_t) xdr_fnClientLockPrint_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientlockprint_1_svc;
		break;

	case fnRpc_fnClientTransactionLockGet:
		_xdr_argument = (xdrproc_t) xdr_fnClientTransactionLockGet_args;
		_xdr_result = (xdrproc_t) xdr_fnClientTransactionLockGet_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclienttransactionlockget_1_svc;
		break;

	case fnRpc_fnServerTransactionLockInsert:
		_xdr_argument = (xdrproc_t) xdr_fnServerTransactionLockInsert_args;
		_xdr_result = (xdrproc_t) xdr_fnServerTransactionLockInsert_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservertransactionlockinsert_1_svc;
		break;

	case fnRpc_fnServerTransactionLockSet:
		_xdr_argument = (xdrproc_t) xdr_fnServerTransactionLockSet_args;
		_xdr_result = (xdrproc_t) xdr_fnServerTransactionLockSet_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservertransactionlockset_1_svc;
		break;

	case fnRpc_fnServerTransactionUnlock:
		_xdr_argument = (xdrproc_t) xdr_fnServerTransactionUnlock_args;
		_xdr_result = (xdrproc_t) xdr_fnServerTransactionUnlock_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservertransactionunlock_1_svc;
		break;

	case fnRpc_fnServerTransactionUnlockAll:
		_xdr_argument = (xdrproc_t) xdr_fnServerTransactionUnlockAll_args;
		_xdr_result = (xdrproc_t) xdr_fnServerTransactionUnlockAll_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservertransactionunlockall_1_svc;
		break;

	case fnRpc_fnServerTransactionUnlockAllAll:
		_xdr_argument = (xdrproc_t) xdr_fnServerTransactionUnlockAllAll_args;
		_xdr_result = (xdrproc_t) xdr_fnServerTransactionUnlockAllAll_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservertransactionunlockallall_1_svc;
		break;

	case fnRpc_fnShortMakeReadOnly:
		_xdr_argument = (xdrproc_t) xdr_fnShortMakeReadOnly_args;
		_xdr_result = (xdrproc_t) xdr_fnShortMakeReadOnly_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnshortmakereadonly_1_svc;
		break;

	case fnRpc_fnServerTransactionBegin:
		_xdr_argument = (xdrproc_t) xdr_fnServerTransactionBegin_args;
		_xdr_result = (xdrproc_t) xdr_fnServerTransactionBegin_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservertransactionbegin_1_svc;
		break;

	case fnRpc_fnServerTransactionCancel:
		_xdr_argument = (xdrproc_t) xdr_fnServerTransactionCancel_args;
		_xdr_result = (xdrproc_t) xdr_fnServerTransactionCancel_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservertransactioncancel_1_svc;
		break;

	case fnRpc_fnServerTransactionEnd:
		_xdr_argument = (xdrproc_t) xdr_fnServerTransactionEnd_args;
		_xdr_result = (xdrproc_t) xdr_fnServerTransactionEnd_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservertransactionend_1_svc;
		break;

	case fnRpc_fnServerTransactionFlush_batch:
		_xdr_argument = (xdrproc_t) xdr_SHORTOBJID;
		_xdr_result = (xdrproc_t) xdr_void;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnservertransactionflush_batch_1_svc;
		break;

	case fnRpc_fnServerDbTransactionP:
		_xdr_argument = (xdrproc_t) xdr_fnServerDbTransactionP_args;
		_xdr_result = (xdrproc_t) xdr_fnServerDbTransactionP_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverdbtransactionp_1_svc;
		break;

	case fnRpc_fnClientBtreeClear:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreeClear_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreeClear_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreeclear_1_svc;
		break;

	case fnRpc_fnClientBtreeCount:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreeCount_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreeCount_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreecount_1_svc;
		break;

	case fnRpc_fnServerBtreeDelete:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeDelete_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeDelete_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreedelete_1_svc;
		break;

	case fnRpc_fnServerBtreeDeleteByFloat:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeDeleteByFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeDeleteByFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreedeletebyfloat_1_svc;
		break;

	case fnRpc_fnServerBtreeDeleteByDouble:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeDeleteByDouble_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeDeleteByDouble_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreedeletebydouble_1_svc;
		break;

	case fnRpc_fnServerBtreeDeleteByString:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeDeleteByString_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeDeleteByString_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreedeletebystring_1_svc;
		break;

	case fnRpc_fnServerBtreeInsert:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeInsert_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeInsert_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreeinsert_1_svc;
		break;

	case fnRpc_fnServerBtreeInsertByFloat:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeInsertByFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeInsertByFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreeinsertbyfloat_1_svc;
		break;

	case fnRpc_fnServerBtreeInsertByDouble:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeInsertByDouble_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeInsertByDouble_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreeinsertbydouble_1_svc;
		break;

	case fnRpc_fnServerBtreeInsertByString:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeInsertByString_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeInsertByString_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreeinsertbystring_1_svc;
		break;

	case fnRpc_fnServerBtreemapSearch:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapSearch_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapSearch_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapsearch_1_svc;
		break;

	case fnRpc_fnServerBtreemapSearchByFloat:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapSearchByFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapSearchByFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapsearchbyfloat_1_svc;
		break;

	case fnRpc_fnServerBtreemapSearchByDouble:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapSearchByDouble_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapSearchByDouble_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapsearchbydouble_1_svc;
		break;

	case fnRpc_fnServerBtreemapSearchByString:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapSearchByString_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapSearchByString_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapsearchbystring_1_svc;
		break;

	case fnRpc_fnServerBtreemapSeek:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapSeek_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapSeek_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapseek_1_svc;
		break;

	case fnRpc_fnServerBtreemapSeekSet:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapSeekSet_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapSeekSet_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapseekset_1_svc;
		break;

	case fnRpc_fnServerBtreemapFirst:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapFirst_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapFirst_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapfirst_1_svc;
		break;

	case fnRpc_fnServerBtreemapFirstByFloat:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapFirstByFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapFirstByFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapfirstbyfloat_1_svc;
		break;

	case fnRpc_fnServerBtreemapFirstByDouble:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapFirstByDouble_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapFirstByDouble_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapfirstbydouble_1_svc;
		break;

	case fnRpc_fnServerBtreemapFirstByString:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreemapFirstByString_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreemapFirstByString_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreemapfirstbystring_1_svc;
		break;

	case fnRpc_fnClientBtreemapNext:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreemapNext_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreemapNext_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreemapnext_1_svc;
		break;

	case fnRpc_fnClientBtreemapLast:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreemapLast_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreemapLast_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreemaplast_1_svc;
		break;

	case fnRpc_fnClientBtreePrint:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreePrint_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreePrint_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreeprint_1_svc;
		break;

	case fnRpc_fnServerBtreeSearch:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeSearch_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeSearch_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreesearch_1_svc;
		break;

	case fnRpc_fnServerBtreeSearchByFloat:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeSearchByFloat_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeSearchByFloat_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreesearchbyfloat_1_svc;
		break;

	case fnRpc_fnServerBtreeSearchByDouble:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeSearchByDouble_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeSearchByDouble_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreesearchbydouble_1_svc;
		break;

	case fnRpc_fnServerBtreeSearchByString:
		_xdr_argument = (xdrproc_t) xdr_fnServerBtreeSearchByString_args;
		_xdr_result = (xdrproc_t) xdr_fnServerBtreeSearchByString_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnserverbtreesearchbystring_1_svc;
		break;

	case fnRpc_fnClientBtreeRoot:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreeRoot_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreeRoot_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreeroot_1_svc;
		break;

	case fnRpc_fnClientBtreeSize:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreeSize_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreeSize_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreesize_1_svc;
		break;

	case fnRpc_fnClientBtreeTestMode:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreeTestMode_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreeTestMode_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreetestmode_1_svc;
		break;

	case fnRpc_fnClientBtreePageSize:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreePageSize_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreePageSize_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreepagesize_1_svc;
		break;

	case fnRpc_fnClientBtreepageParent:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreepageParent_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreepageParent_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreepageparent_1_svc;
		break;

	case fnRpc_fnClientBtreepageCount:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreepageCount_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreepageCount_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreepagecount_1_svc;
		break;

	case fnRpc_fnClientBtreepageGetSize:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreepageGetSize_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreepageGetSize_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreepagegetsize_1_svc;
		break;

	case fnRpc_fnClientBtreepageItem:
		_xdr_argument = (xdrproc_t) xdr_fnClientBtreepageItem_args;
		_xdr_result = (xdrproc_t) xdr_fnClientBtreepageItem_rets;
		local = (char *(*)(char *, struct svc_req *)) fnrpc_fnclientbtreepageitem_1_svc;
		break;
...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, PLOBD, PLOBDVERS, plobd_1, IPPROTO_UDP)) {
		fprintf (stderr, "unable to register (PLOBD, PLOBDVERS, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, PLOBD, PLOBDVERS, plobd_1, IPPROTO_TCP)) {
		fprintf (stderr, "unable to register (PLOBD, PLOBDVERS, tcp).");
		exit(1);
	}
