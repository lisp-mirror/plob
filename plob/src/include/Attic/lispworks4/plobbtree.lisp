...
;;;; -------------------------------------------------------------------------
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdHeap    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (szKey    #.:const-c-string           :vector-in)
                   ))    ;
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdMapper    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (szKeyLower    #.:const-c-string           :vector-in)
		   ...
		   (szKeyUpper    #.:const-c-string           :vector-in)
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdHeap    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (
			      pnValueKey    #.:pointer             :vector-out)
             

		   (
			      pnTypeTagKey    #.:pointer             :vector-out)
             

		   (
			      pnValueData    #.:pointer             :vector-out)
             

		   (
			      pnTypeTagData    #.:pointer             :vector-out)
             

		   (
			      poNext    #.:pointer             :vector-out)
                   ))    ;
