...
;;;; -------------------------------------------------------------------------
  ...
  (define-foreign-function
		 ...
		 ( (lpoShortObjIdMapper    #.C2L_SHORTOBJID      :value-out)
		   ...
		   (pnValueKey    #.:simple-vector
			      :vector-out)
             

		   (pnTypeTagKey    #.:simple-vector
			      :vector-out)
             

		   (pnValueData    #.:simple-vector
			      :vector-out)
             

		   (pnTypeTagData    #.:simple-vector
			      :vector-out)
                   ))    ;
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdHeap    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (
			      pnValueKey    #.:simple-vector            :vector-out)
             

		   (
			      pnTypeTagKey    #.:simple-vector            :vector-out)
             

		   (
			      pnValueData    #.:simple-vector            :vector-out)
             

		   (
			      pnTypeTagData    #.:simple-vector            :vector-out)
             

		   (
			      poNext    #.:simple-vector            :vector-out)
                   ))    ;
