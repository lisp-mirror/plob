...
;;;; -------------------------------------------------------------------------
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdHeap    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (pnFlags    #.:fixnum           :value-out)
             

		   (pnMinimumKey    #.:fixnum           :value-out)
             

		   (pnMaximumKey    #.:fixnum           :value-out)
             

		   (
			      pnKeyAlignment    #.:fixnum           :value-out)
                   ))    ;
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdHeap    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (nExtraReferences    #.:fixnum           :value-in)
             

		   (eTypeTagValues    #.C2L_SHTYPETAG      :value-in)
             

		   (nExtraValues    #.:fixnum           :value-in)
                   ))    ;
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdHeap    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (nSizeInCharacters    #.:fixnum           :value-in)
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdHeap    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (nObjIds    #.:fixnum           :value-in)
             

		   (pObjIds    #.:simple-vector
			      :vector-out)
             

		   (pnTypeTags    #.:simple-vector
			      :vector-out)
                   ))    ;
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdHeap    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (nSizeInElements    #.:fixnum           :value-in)
             

		   (pBuffer    #.:simple-vector
			      :vector-out)
  ...
  (define-foreign-function
		 ...
		 ( (oShortObjIdHeap    #.C2L_SHORTOBJID      :value-in)
		   ...
		   (pnMaximumSpace    #.:fixnum           :value-out)
             

		   (pnAllocatedSpace    #.:fixnum           :value-out)
             

		   (
			      pnUnallocatedSpace    #.:fixnum           :value-out)
             

		   (
			      pnUnusedAllocatedSpace    #.:fixnum           :value-out)
             

		   (
			      pnAllocatedManagementSpace    #.:fixnum           :value-out)
             

		   (
			      pnNumberOfObjects    #.:fixnum           :value-out)
                   ))    ;
