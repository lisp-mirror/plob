...
| Extern variables
 ------------------------------------------------------------------------- */
const char		szNIL []		= "NIL";
const char		szT []			= "T";
const char		szREAD []		= "READ";
const char		szWRITE []		= "WRITE";
const char		szREADWRITE []		= "READ-WRITE";
const char		szPACKAGE []		= "PACKAGE";

const char		szCOMMONLISP []		= SZCOMMONLISP;
const char		szKEYWORD []		= SZKEYWORD;
const char		szPLOB []		= SZPLOB;
...
void			fnInitCommonStructModule	( void )
{
  static CLASSINFO	ClassInfoTable []	= {
    { (SHTYPETAG) eshStructureTag,
        SZCOMMONLISP,
        "structure",
        eshStructObjIdSize * sizeof ( psint ) * nBitsPerByte,
        0,
        (LPCSTR) NULL,
        typeVarSizeObjIdP
    }
  ...
  PROCEDURE	( fnInitCommonStructModule );
...
{
  PROCEDURE	( fnDeinitCommonStructModule );
