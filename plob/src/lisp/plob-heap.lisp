 ...
 \\Fcite{(setf p-marker)}."
  ...
  (multiple-value-bind (the-p-marker the-p-marker-type-tag)
    ...
    (declare (type ;;; 2005-04-06 hkirschk: Corrected for LispWorks 4.4
                   ...
                   #+:small-fixnum integer
                   fixnum the-p-marker)
             (type fixnum the-p-marker-type-tag)
             (ignore the-p-marker))
...
\\Seealsolabel
 ...
 \\fcite{sh-in-transaction-p}."
  ...
  (let ((p-objid (persistent-object-objid p-heap)))
    (declare (type (or null ;;; 2005-04-06 hkirschk: Corrected for LispWorks 4.4
			    #-:small-fixnum fixnum
			    #+:small-fixnum integer
			    integer) p-objid)
...
\\Seealsolabel
 ...
 \\fcite{is-registered-object}."
  ...
  ;; 2005-05-25 hkirschk: do not cache instances of persistent-object,
  ;; since these are only used as proxies:
  (unless (eq (class-of t-object) +persistent-object-class+)
