...
;;; ---------------------------------------------------------------------------
(defun p-exit (&optional force (url *database-url*))
  #+:lisp-doc "
\\Argumentslabel
 \\isabool{force}
\\Purposelabel
...
;;; ---------------------------------------------------------------------------
(defun p-reset (&optional force	(url *database-url*))
  #+:lisp-doc "
\\Argumentslabel
 \\isabool{force}
\\Purposelabel
...
;;; ---------------------------------------------------------------------------
(defun p-restart (&optional force (url *database-url*))
  #+:lisp-doc "
\\Argumentslabel
 \\isabool{force}
\\Purposelabel
