...
\text{$\uparrow$ Subklasse von} & \text{$\Uparrow$ Instanz von} \\%
\dgmc{\mc} & \dgc{\cls} & \dgi{Instanz}%
\end{diagram}}%
%
...
\end{diagram}}%
%
\def\dgmc#1{\Framed<5pt>\grow{\Text{#1}}}%	% diagram: Metaobjekt-Klasse
\def\dgc#1{\framed<5pt>\grow{\Text{#1}}}%	% diagram: Klasse
\def\dgi#1{\framed\grow{\Text{#1}}}%		% diagram: Instanz
%
