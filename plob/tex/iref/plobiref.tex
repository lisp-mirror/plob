...
\begincncom[Internal]{+bignum-poi-tag+}
...
\Valuelabel
\begin{CompactCode}
`((,+seek-set+ . :set) (,+seek-current+ . :current) (,+seek-end+ . :end))
\end{CompactCode}
...
\Syntaxlabel
\Defgen {btree-mapper-search-internal} {{\funarg{p-mapper-objid}} {\funarg{p-btree-objid}} {\funarg{start-value}} {\funarg{start-type-tag}} {\funarg{compare-start}} {\funarg{end-value}} {\funarg{end-type-tag}} {\funarg{compare-end}} {\funarg{descending}} {\funarg{p-heap}}}
...
\flabel{\protect\mtd}{btree-mapper-search-internal (t t float t t float t t t t)}{}
{\Defmeth {btree-mapper-search-internal} {{\funarg{p-mapper-objid}} {\funarg{p-btree-objid}} (\funarg{start-value}\ \ObjectWithRef{float}) {\funarg{start-type-tag}} {\funarg{compare-start}} (\funarg{end-value}\ \ObjectWithRef{float}) {\funarg{end-type-tag}} {\funarg{compare-end}} {\funarg{descending}} {\funarg{p-heap}}}}
%
% No behavior is specified for this method beyond that which is specified
% for the generic function.

\flabel{\protect\mtd}{btree-mapper-search-internal (t t integer t t integer t t t t)}{}
{\Defmeth {btree-mapper-search-internal} {{\funarg{p-mapper-objid}} {\funarg{p-btree-objid}} (\funarg{start-value}\ \ObjectWithRef{integer}) {\funarg{start-type-tag}} {\funarg{compare-start}} (\funarg{end-value}\ \ObjectWithRef{integer}) {\funarg{end-type-tag}} {\funarg{compare-end}} {\funarg{descending}} {\funarg{p-heap}}}}
%
% No behavior is specified for this method beyond that which is specified
% for the generic function.

\flabel{\protect\mtd}{btree-mapper-search-internal (t t string t t string t t t t)}{}
{\Defmeth {btree-mapper-search-internal} {{\funarg{p-mapper-objid}} {\funarg{p-btree-objid}} (\funarg{start-value}\ \ObjectWithRef{string}) {\funarg{start-type-tag}} {\funarg{compare-start}} (\funarg{end-value}\ \ObjectWithRef{string}) {\funarg{end-type-tag}} {\funarg{compare-end}} {\funarg{descending}} {\funarg{p-heap}}}}
%
% No behavior is specified for this method beyond that which is specified
% for the generic function.
...
\Valuelabel
\begin{CompactCode}
`((,+eq+ excl::bq-comma #'eq) (,+eq+ . eq) (,+eql+ excl::bq-comma #'eql)
  (,+eql+ . eql) (,+equal+ excl::bq-comma #'equal) (,+equal+ . equal))
\end{CompactCode}
...
\beginfncom[Internal]{c-int-vector}

\Syntaxlabel
\Defun {c-int-vector} {{\funarg{x}} {\funarg{location}}}


\endcom

\beginfncom[Internal]{(setf c-int-vector)}

\Syntaxlabel
\Defun {(setf c-int-vector)} {{\funarg{new-value}} {\funarg{x}} {\funarg{location}}}


\endcom

\beginfncom[Internal]{c-int-vector-fill}

\Syntaxlabel
\Defun {c-int-vector-fill} {{\funarg{x}} {\funarg{new-value}}}


\endcom

\beginfncom[Internal]{c-int-vector-length}

\Syntaxlabel
\Defun {c-int-vector-length} {{\funarg{x}}}


\endcom

\beginfncom[Internal]{(setf c-int-vector-length)}

\Syntaxlabel
\Defun {(setf c-int-vector-length)} {{\funarg{new-length}} {\funarg{x}}}
...
\Defdslot {objid->object-cache} {(make-hash-table :test #'eql :size 100000 :rehash-size 2.0)}
...
\Defdslot {object->objid-cache} {(make-hash-table :test #'eq :size 100000 :rehash-size 2.0)}
...
\message{^^JGeneric function clos::canonicalize-class-options has no methods.^^J}
\message{^^JGeneric function clos::canonicalize-defclass-slot has no methods.^^J}
...
{\message{^^JUndocumented generic function (setf
                                            plob::class-description-dependent).^^J}
\nodefgeneric}
...
\beginfncom[Internal]{compute-c-int-vector-location}

\Syntaxlabel
\Defun {compute-c-int-vector-location} {{\funarg{x}} {\funarg{location}}}
...
\Purposelabel
A vriable mapping the data vector of an array to
...
\begincncom[Internal]{+error-message-buffer-size+}
...
\Valuelabel
\begin{CompactCode}
`((,+flush-never+ . :never) (,+flush-seldom+ . :seldom)
  (,+flush-sometimes+ . :sometimes) (,+flush-often+ . :often)
  (,+flush-always+ . :always))
\end{CompactCode}
...
\flabel{\protect\mtd}{(setf getbtree-with-data) :around (t persistent-clos-object cached-btree t t t
                                   t)}{}
...
\Valuelabel
\begin{CompactCode}
`((hash-table excl::bq-comma #'make-hash-table)
  (btree excl::bq-comma #'make-btree))
\end{CompactCode}
...
\begincncom[Internal]{+length-structure-persistent-slots+}

\Valuelabel
\begin{CompactCode}
(length +structure-persistent-slots+)
\end{CompactCode}

\Purposelabel
The length of the list in \fcite{+structure-persistent-slots+}.
...
\flabel{\protect\mtd}{load-instance-for-class ((eql 'persistent-hash-table) structure-description t
                         t t)}{}
...
\flabel{\protect\mtd}{load-instance-for-redefined-class (t structure-description
                                   structure-description t t t)}{}
...
\beginfncom[Internal]{make-c-int-vector}

\Syntaxlabel
\Defun {make-c-int-vector} {{\funarg{length}}}
...
\Syntaxlabel
\Defgen {mapbtree-internal} {{\funarg{map-function}} {\funarg{p-btree-objid}} {\funarg{start-value}} {\funarg{start-type-tag}} {\funarg{compare-start}} {\funarg{end-value}} {\funarg{end-type-tag}} {\funarg{compare-end}} {\funarg{descending}} {\funarg{p-heap}}}
...
\flabel{\protect\mtd}{mapbtree-internal (t t float t t float t t t t)}{}
{\Defmeth {mapbtree-internal} {{\funarg{map-function}} {\funarg{p-btree-objid}} (\funarg{start-value}\ \ObjectWithRef{float}) {\funarg{start-type-tag}} {\funarg{compare-start}} (\funarg{end-value}\ \ObjectWithRef{float}) {\funarg{end-type-tag}} {\funarg{compare-end}} {\funarg{descending}} {\funarg{p-heap}}}}
%
% No behavior is specified for this method beyond that which is specified
% for the generic function.

\flabel{\protect\mtd}{mapbtree-internal (t t integer t t integer t t t t)}{}
{\Defmeth {mapbtree-internal} {{\funarg{map-function}} {\funarg{p-btree-objid}} (\funarg{start-value}\ \ObjectWithRef{integer}) {\funarg{start-type-tag}} {\funarg{compare-start}} (\funarg{end-value}\ \ObjectWithRef{integer}) {\funarg{end-type-tag}} {\funarg{compare-end}} {\funarg{descending}} {\funarg{p-heap}}}}
%
% No behavior is specified for this method beyond that which is specified
% for the generic function.

\flabel{\protect\mtd}{mapbtree-internal (t t string t t string t t t t)}{}
{\Defmeth {mapbtree-internal} {{\funarg{map-function}} {\funarg{p-btree-objid}} (\funarg{start-value}\ \ObjectWithRef{string}) {\funarg{start-type-tag}} {\funarg{compare-start}} (\funarg{end-value}\ \ObjectWithRef{string}) {\funarg{end-type-tag}} {\funarg{compare-end}} {\funarg{descending}} {\funarg{p-heap}}}}
%
% No behavior is specified for this method beyond that which is specified
% for the generic function.
...
\message{^^JGeneric function clos:method-function has no methods.^^J}
\message{^^JGeneric function clos:method-lambda-list has no methods.^^J}
\message{^^JGeneric function method-qualifiers has no methods.^^J}
\begingfcom[Internal]{method-slot-name}

\Syntaxlabel
\Defgen {method-slot-name} {{\funarg{method}}}

\IfFLabelExists{plob::method-slot-name}
{\SeeAt\ \fcite{plob::method-slot-name}.}
{\message{^^JUndocumented generic function plob::method-slot-name.^^J}
\nodefgeneric}


\Methodslabel

\flabel{\protect\mtd}{method-slot-name (standard-accessor-method)}{}
{\Defmeth {method-slot-name} {(\funarg{method}\ \ObjectWithRef{standard-accessor-method})}}
%
% No behavior is specified for this method beyond that which is specified
% for the generic function.
...
\message{^^JGeneric function clos:method-specializers has no methods.^^J}
...
\beginmccom[Internal]{namestring-if}

\Syntaxlabel
\Defmac {namestring-if} {{\funarg{pathname}}}
...
\message{^^JGeneric function clos::obsolete-instance-trap-internal has no methods.^^J}
...
\beginfncom[Internal]{p-destroy}

\Syntaxlabel
\Defun {p-destroy} {{\funarg{p-objid}} {\opt} {\funarg{p-heap}}}
...
\flabel{\protect\mtd}{p-objid-to-t-object (t (eql +short-float-type-tag+) t t)}{}
{\Defmeth {p-objid-to-t-object} {{\funarg{p-objid}} (\funarg{p-objid-type-tag}\ \ObjectWithRef{(eql +short-float-type-tag+)}) {\funarg{depth}} {\funarg{p-heap}}}}
%
% No behavior is specified for this method beyond that which is specified
% for the generic function.
...
(let ((the-class (find-class 'persistent-clos-object nil)))
  (if the-class
      the-class
    (ensure-class 'persistent-clos-object :metaclass 'persistent-metaclass)))
\end{CompactCode}
...
Check if \funarg{slot}\ is a member of the slots found in
 \fcite{+structure-persistent-slots+}.
...
\begincncom[Internal]{+reverse-structure-persistent-slots+}

\Valuelabel
\begin{CompactCode}
(reverse +structure-persistent-slots+)
\end{CompactCode}

\Purposelabel
The reverse list of the value of \fcite{+structure-persistent-slots+}.
...
\Syntaxlabel
\Defun {sh-btree-map} {{\funarg{p-heap-objid}} {\funarg{p-objid-btree}} {\funarg{map-function}} {\opt} {\funarg{immediate-key-start-value}} {\funarg{immediate-key-start-type-tag}} {\funarg{compare-start-key}} {\funarg{immediate-key-end-value}} {\funarg{immediate-key-end-type-tag}} {\funarg{compare-end-key}} {\funarg{descending}}}
...
\Syntaxlabel
\Defun {sh-btree-map-by-string} {{\funarg{p-heap-objid}} {\funarg{p-objid-btree}} {\funarg{map-function}} {\opt} {\funarg{immediate-key-start-vector}} {\funarg{immediate-key-start-type-tag}} {\funarg{compare-start-key}} {\funarg{immediate-key-end-vector}} {\funarg{immediate-key-end-type-tag}} {\funarg{compare-end-key}} {\funarg{descending}}}
...
\Syntaxlabel
\Defun {sh-btree-map-search} {{\funarg{p-heap-objid}} {\funarg{p-objid-mapper}} {\funarg{p-objid-btree}} {\opt} {\funarg{immediate-key-start-value}} {\funarg{immediate-key-start-type-tag}} {\funarg{compare-start-key}} {\funarg{immediate-key-end-value}} {\funarg{immediate-key-end-type-tag}} {\funarg{compare-end-key}} {\funarg{descending}}}
...
\Syntaxlabel
\Defun {sh-exit} {{\opt} {\funarg{force}} {\funarg{url}}}
...
\Syntaxlabel
\Defun {sh-reset} {{\opt} {\funarg{force}} {\funarg{url}}}
...
\Syntaxlabel
\Defun {sh-restart} {{\opt} {\funarg{force}} {\funarg{url}}}
...
\message{^^JGeneric function clos:slot-definition-location has no methods.^^J}
\message{^^JGeneric function clos:slot-definition-readers has no methods.^^J}
\message{^^JGeneric function clos:slot-definition-writers has no methods.^^J}
...
\flabel{\protect\mtd}{slot-description-equal-p (effective-slot-description
                          effective-slot-description)}{}
...
\flabel{\protect\mtd}{slot-description-equal-p (structure-slot-description
...
\begin{CompactCode}
(mapcar #'find-class
        '(t standard-object metaobject class built-in-class standard-class
          slot-definition standard-slot-definition
          standard-direct-slot-definition standard-effective-slot-definition
          method standard-method standard-accessor-method
          standard-reader-method standard-writer-method method-combination))
\end{CompactCode}
...
\Defdslot {t-name->slot-cache} {(make-hash-table :test #'eq)}
...
\begincncom[Internal]{+structure-persistent-slots+}
...
\Seealsolabel
 \Fcite{+reverse-structure-persistent-slots+}.
...
\flabel{\protect\mtd}{t-object-to-p-objid-using-class (hash-table t t t)}{}
{\Defmeth {t-object-to-p-objid-using-class} {(\funarg{t-object}\ \ObjectWithRef{hash-table}) {\funarg{t-class}} {\funarg{depth}} {\funarg{p-heap}}}}
%
% No behavior is specified for this method beyond that which is specified
% for the generic function.
...
\flabel{\protect\mtd}{t-object-to-p-objid-using-class (structure-effective-slot-definition
                                 standard-class t t)}{}
{\Defmeth {t-object-to-p-objid-using-class} {(\funarg{t-object}\ \ObjectWithRef{structure-effective-slot-definition}) (\funarg{t-class}\ \ObjectWithRef{standard-class}) {\funarg{depth}} {\funarg{p-heap}}}}
Stores \funarg{t-object}\ as an instance of
 \fcite{structure-slot-description}.
