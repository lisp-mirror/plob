...
The \lisp{:dependent}\ flag is placed onto the referenced object, and
not on the referencing object.  Clever usage of this option will
result in much faster access to instances of \lisp{:dependent}\ marked
classes being referenced by other instances, since communication
overhead is dramatically reduced for such instances.  Exhaustive use
of this option may result in big, maybe redundant data packages
...
\centerline{\psfig{figure=\Path/numtax.pdf}}
...
\emph{This workaround has only to be used under these
