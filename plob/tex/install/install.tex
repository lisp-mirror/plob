...
The binaries for a Windows/NT server and the sources for a \lwcl\ 
4.0.1 and a \allegrocl\ 5.0 beta client installation are contained in
this distribution.  For using \plobwoexcl's Windows/NT server with a
\lwcl\ 4.0.1 or \allegrocl\ 5.0 beta client, do the following.
%% \sloppy
\begin{enumerate}
...
\item\label{itm:ntcompile} For both \lwcl\ 4.0.1\ and \allegrocl\
5.0 beta, change into the
